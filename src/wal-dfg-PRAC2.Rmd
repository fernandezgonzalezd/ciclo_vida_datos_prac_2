...
```{r, tratamiento_outliers, eval=TRUE, echo=TRUE, warning=FALSE}
...
#### 3.2.1. Exportación de los datos preprocesados
...
tabla.coeficientes <- matrix(c(1, summary(lm_modelo_1)$r.squared, 
